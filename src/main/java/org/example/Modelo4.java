...
public class Modelo4 {
    public static void main(String[] args) throws IOException {
        ...
        int epochs = 50; // Número de épocas para entrenar el modelo
...
// 1. Crear el FileSplit
        ...
        INDArray classWeights = Nd4j.create(new double[] {1.0, 2.5});
...
// Guardar el modelo entrenado
    ...
    private static MultiLayerConfiguration getConfigForFourthModel(int channels, INDArray classWeights, int outputNum, int height, int width) {
        return new NeuralNetConfiguration.Builder()
                ...
                .layer(new DenseLayer.Builder()
                        ...
                        .activation(Activation.RELU)
                        .build())
                .layer(new OutputLayer.Builder(new LossMCXENT(classWeights))
                        .nOut(outputNum)
